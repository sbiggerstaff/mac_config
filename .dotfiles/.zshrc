...
export ZSH="/Users/stephenbiggerstaff/.oh-my-zsh"
...
plugins=(git common-aliases ant copydir copyfile gradle heroku npm nvm)
...
alias audio='sudo launchctl stop com.apple.audio.coreaudiod && sudo launchctl start com.apple.audio.coreaudiod' #Fix for crackling speakers on 16" MBP
...
source ~/mac_config/scripts/functions.sh
